...
//countGoods测试
it('should  return a array when invoke countGoods given barcodes=[\'0001\', \'0003\', \'0005\', \'0003\']', function () {
    //given
    const barcodes = ['0001', '0003', '0005', '0003'];
    //when
    const result = receipt.countGoods(barcodes);
    //then
    expect(result).toEqual([{id: '0001', count: 1}, {id: '0003', count: 2}, {id: '0005', count: 1}]);
});
//isExist测试
it('should be return false when invoke isExist given barcodeChildElement=\'0011\'', function () {
    //given
